...
public class FSMLogHistory : MonoBehaviour
{
    [System.Serializable]
    ...
    private static FSMLogHistory instance;
    public static FSMLogHistory Instance
    {
        get
        {
            if (instance == null)
            {
                instance = GameObject.FindObjectOfType<FSMLogHistory>();
            }
            return instance;
        }
    }
